...
<body>
    ...
    <div class="container">
        ...
        <form action="treatmentWorkAdd.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group my-3">
              ...
              <input type="text" id="logiciel" name="logiciel" class="form-control" value="">
          </div>
          <div class="form-group my-3">
              <label for="categorie">Catégorie</label>
              <input type="text" id="categorie" name="categorie" class="form-control" value="">
          </div>
          <div class="form-group my-3">
